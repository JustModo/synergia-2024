...
export default function Logo({ position }) {
  ...
  return (
    <Fragment>
      {/* <motion.img
        src={LogoSVG}
        className={`absolute transition-opacity duration-500 w-3/5 max-w-md select-none -mt-16 ${
      ...
      <motion.svg
        ...
        className={`absolute transition-opacity duration-500 w-3/5 max-w-md select-none -mt-32 ${
          fadeIn ? "opacity-100" : "opacity-0"
        }`}
        style={{ x: position }}
      >
        <defs>
          <style>
            {`.fcls-1 {
        fill: url(#flinear-gradient);
      }

      .fcls-1, .fcls-2, .fcls-3, .fcls-4, .fcls-5, .fcls-6, .fcls-7, .fcls-8 {
        stroke-width: 0px;
      }

      .fcls-2 {
        fill: url(#flinear-gradient-6);
      }

      .fcls-3 {
        fill: url(#flinear-gradient-5);
      }

      .fcls-4 {
        fill: url(#flinear-gradient-2);
      }

      .fcls-5 {
        fill: url(#flinear-gradient-7);
      }

      .fcls-6 {
        fill: url(#flinear-gradient-3);
      }
